...
const ChatbotComponent = ({ helpOptions, params }) => {
  ...
  const cards_content = [
    ...
    },
    {
      ...
      img: "https://dev.hakini.net/assets/images/How1.svg",
      description: "تقدم منصة حاكيني مجموعة من الاختبارات النفسيه لتحليل الشخصية، مقاييس نفسية و اختبارات صحة نفسية، حالتك النفسية من خلال الاختبارات النفسية الشائعة التي تستخدم على يد أفضل دكتور و دكتورة الطب النفسي والاستشاريين النفسيين.",
      path: "exams",
    },
    {
    ...
    },
    {
      ...
      img: require("../../../../images/exams_icon.png"),
